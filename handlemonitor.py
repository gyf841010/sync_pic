...
if __name__ == '__main__':
    cmd = 'python handle_pic.py 1>/dev/null 2>/dev/null&'
    a = os.popen("ps -ef | grep handle_pic.py | awk '/\<handle_pic.py$/{ print }' | awk '{ if(NF==8 || NF>8 && index($(NF-1),\"python\")>0) print}'").read()
